<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FirstWebPage.aspx.cs" Inherits="FirstWebPage" %>
...
&nbsp;
            ...
            <br />
            <br />
            <asp:Label ID="Label1" runat="server" Text="Label" ForeColor="SandyBrown"></asp:Label>
            <br />
            <br />
